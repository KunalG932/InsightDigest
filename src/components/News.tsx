              ...
              <div className="p-6 space-y-4">
                <div className="space-y-2">
                  <Link href={item.url} target="_blank" rel="noopener noreferrer" className="block">
                    <h3 className="text-xl font-bold text-slate-100 line-clamp-2 group-hover:text-cyan-400 transition-colors">
                      {item.title}
                    </h3>
                  </Link>
                  ...
                  <div className="flex items-center gap-4">
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-400 
                               text-slate-900 font-medium transition-colors duration-300 focus:outline-none focus:ring-2 
                               focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-slate-900"
                    >
                      Read More
